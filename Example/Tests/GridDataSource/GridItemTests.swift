...
private struct GridItemDescriptorMock: GridViewDescriptor {
...
private struct ItemDescriptorMock: ItemViewDescriptor {
    var reuseIdentifier: String
}

private struct GridItemMock: GridItemViewModel {
